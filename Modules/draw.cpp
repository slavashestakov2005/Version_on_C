        ...
        Value* execute(std::vector<Value*> values){
            ...
            while (window.pollEvent(event)){
                ...
                if (event.type == sf::Event::KeyPressed){
                    if (event.key.code == sf::Keyboard::Escape) return new NumberValue(int(Keys::ESCAPE));
                    if (event.key.code == sf::Keyboard::Up) return new NumberValue(int(Keys::UP));
                    if (event.key.code == sf::Keyboard::Down) return new NumberValue(int(Keys::DOWN));
                    if (event.key.code == sf::Keyboard::Left) return new NumberValue(int(Keys::LEFT));
                    if (event.key.code == sf::Keyboard::Right) return new NumberValue(int(Keys::RIGHT));
                    if (event.key.code == sf::Keyboard::Space) return new NumberValue(int(Keys::SPACE));
                }
            }
...
void Draw::initConstants(){
    Variables::set("KB_ESCAPE", new NumberValue(int(Keys::ESCAPE)));
    Variables::set("KB_UP", new NumberValue(int(Keys::UP)));
    Variables::set("KB_DOWN", new NumberValue(int(Keys::DOWN)));
    Variables::set("KB_LEFT", new NumberValue(int(Keys::LEFT)));
    Variables::set("KB_RIGHT", new NumberValue(int(Keys::RIGHT)));
    Variables::set("KB_SPACE", new NumberValue(int(Keys::SPACE)));
}
